...
import (
	"fmt"
	"sbp/internal/infrastructure/rabbit-intapi/client"
...
func New(l *zap.SugaredLogger, url, port, user, password string) (svc *Service, err error) {
	...
	svc.eventsPublisher, err = rabbitmq.NewPublisher(conn,
		...
		rabbitmq.WithPublisherOptionsExchangeName(string(vo.SbpAdminService)),
	...
	svc.eventsConsumer, err = rabbitmq.NewConsumer(conn,
		...
		string(vo.SbpAdminRoutingKey),
		rabbitmq.WithConsumerOptionsExchangeDeclare,
		rabbitmq.WithConsumerOptionsExchangeName(string(vo.SbpAdminService)),
		rabbitmq.WithConsumerOptionsExchangeKind("direct"),
		rabbitmq.WithConsumerOptionsRoutingKey(string(vo.SbpAdminRoutingKey)),
