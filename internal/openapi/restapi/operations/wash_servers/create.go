...
type CreateHandlerFunc func(CreateParams, *entities.Auth) CreateResponder

// Handle executing the request and returning a response
func (fn CreateHandlerFunc) Handle(params CreateParams, principal *entities.Auth) CreateResponder {
	return fn(params, principal)
}

// CreateHandler interface for that can handle valid create params
type CreateHandler interface {
	Handle(CreateParams, *entities.Auth) CreateResponder
}
...
/*
	Create swagger:route PUT /wash-server/ wash_servers create
