...
type UpdateHandlerFunc func(UpdateParams, *entities.Auth) UpdateResponder

// Handle executing the request and returning a response
func (fn UpdateHandlerFunc) Handle(params UpdateParams, principal *entities.Auth) UpdateResponder {
	return fn(params, principal)
}

// UpdateHandler interface for that can handle valid update params
type UpdateHandler interface {
	Handle(UpdateParams, *entities.Auth) UpdateResponder
}
