...
import (
	...
	"sbp/internal/openapi/restapi/operations"
...
func configureAPI(api *operations.WashSbpAPI) http.Handler {
	...
	if api.WashServersCancelHandler == nil {
		api.WashServersCancelHandler = wash_servers.CancelHandlerFunc(func(params wash_servers.CancelParams, principal *entities.Auth) wash_servers.CancelResponder {
	...
	if api.WashServersPayHandler == nil {
		api.WashServersPayHandler = wash_servers.PayHandlerFunc(func(params wash_servers.PayParams, principal *entities.Auth) wash_servers.PayResponder {
			return wash_servers.PayNotImplemented()
		})
	}
	if api.WashServersSignupHandler == nil {
		api.WashServersSignupHandler = wash_servers.SignupHandlerFunc(func(params wash_servers.SignupParams, principal *entities.Auth) wash_servers.SignupResponder {
