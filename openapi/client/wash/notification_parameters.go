...
// WithBody adds the body to the notification params
func (o *NotificationParams) WithBody(body *models.Notification) *NotificationParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the notification params
func (o *NotificationParams) SetBody(body *models.Notification) {
	o.Body = body
}
