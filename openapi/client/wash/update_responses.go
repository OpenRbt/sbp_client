...
func (o *UpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PATCH /wash/] update", response, response.Code())
	}
}
...
func (o *UpdateNoContent) Error() string {
	return fmt.Sprintf("[PATCH /wash/][%d] updateNoContent ", 204)
}
...
func (o *UpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /wash/][%d] updateBadRequest  %+v", 400, o.Payload)
}
...
func (o *UpdateForbidden) Error() string {
	return fmt.Sprintf("[PATCH /wash/][%d] updateForbidden  %+v", 403, o.Payload)
}
...
func (o *UpdateNotFound) Error() string {
	return fmt.Sprintf("[PATCH /wash/][%d] updateNotFound  %+v", 404, o.Payload)
}
...
func (o *UpdateInternalServerError) Error() string {
	return fmt.Sprintf("[PATCH /wash/][%d] updateInternalServerError  %+v", 500, o.Payload)
}
