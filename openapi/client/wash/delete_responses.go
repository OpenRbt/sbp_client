...
func (o *DeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /wash/] delete", response, response.Code())
	}
}
...
func (o *DeleteNoContent) Error() string {
	return fmt.Sprintf("[DELETE /wash/][%d] deleteNoContent ", 204)
}
...
func (o *DeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /wash/][%d] deleteBadRequest  %+v", 400, o.Payload)
}
...
func (o *DeleteForbidden) Error() string {
	return fmt.Sprintf("[DELETE /wash/][%d] deleteForbidden  %+v", 403, o.Payload)
}
...
func (o *DeleteNotFound) Error() string {
	return fmt.Sprintf("[DELETE /wash/][%d] deleteNotFound  %+v", 404, o.Payload)
}
...
func (o *DeleteInternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /wash/][%d] deleteInternalServerError  %+v", 500, o.Payload)
}
