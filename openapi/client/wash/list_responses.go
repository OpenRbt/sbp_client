...
func (o *ListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /wash/list] list", response, response.Code())
	}
}
...
func (o *ListOK) Error() string {
	return fmt.Sprintf("[GET /wash/list][%d] listOK  %+v", 200, o.Payload)
}
...
func (o *ListOK) GetPayload() []*models.Wash {
	return o.Payload
}
...
func (o *ListBadRequest) Error() string {
	return fmt.Sprintf("[GET /wash/list][%d] listBadRequest  %+v", 400, o.Payload)
}
...
func (o *ListForbidden) Error() string {
	return fmt.Sprintf("[GET /wash/list][%d] listForbidden  %+v", 403, o.Payload)
}
...
func (o *ListNotFound) Error() string {
	return fmt.Sprintf("[GET /wash/list][%d] listNotFound  %+v", 404, o.Payload)
}
...
func (o *ListInternalServerError) Error() string {
	return fmt.Sprintf("[GET /wash/list][%d] listInternalServerError  %+v", 500, o.Payload)
}
