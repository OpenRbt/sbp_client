...
func (o *CreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /wash-server/] create", response, response.Code())
	}
}
...
func (o *CreateOK) Error() string {
	return fmt.Sprintf("[PUT /wash-server/][%d] createOK  %+v", 200, o.Payload)
}
...
func (o *CreateOK) GetPayload() *models.WashServer {
	return o.Payload
}
...
func (o *CreateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /wash-server/][%d] createBadRequest  %+v", 400, o.Payload)
}
...
func (o *CreateInternalServerError) Error() string {
	return fmt.Sprintf("[PUT /wash-server/][%d] createInternalServerError  %+v", 500, o.Payload)
}
