...
// WithBody adds the body to the cancel params
func (o *CancelParams) WithBody(body *models.Cancel) *CancelParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the cancel params
func (o *CancelParams) SetBody(body *models.Cancel) {
	o.Body = body
}
