...
func (o *CreateParams) WithBody(body *models.WashServerCreate) *CreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create params
func (o *CreateParams) SetBody(body *models.WashServerCreate) {
	o.Body = body
}
