...
type CancelHandlerFunc func(CancelParams, *entities.AuthExtended) CancelResponder

// Handle executing the request and returning a response
func (fn CancelHandlerFunc) Handle(params CancelParams, principal *entities.AuthExtended) CancelResponder {
	return fn(params, principal)
}

// CancelHandler interface for that can handle valid cancel params
type CancelHandler interface {
	Handle(CancelParams, *entities.AuthExtended) CancelResponder
}
...
/*
	Cancel swagger:route POST /cancel wash cancel
