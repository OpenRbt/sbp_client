...
type SignupHandlerFunc func(SignupParams, *entities.AuthExtended) SignupResponder

// Handle executing the request and returning a response
func (fn SignupHandlerFunc) Handle(params SignupParams, principal *entities.AuthExtended) SignupResponder {
	return fn(params, principal)
}

// SignupHandler interface for that can handle valid signup params
type SignupHandler interface {
	Handle(SignupParams, *entities.AuthExtended) SignupResponder
}
...
/*
	Signup swagger:route POST /signup wash signup
