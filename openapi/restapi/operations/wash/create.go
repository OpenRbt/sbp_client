...
type CreateHandlerFunc func(CreateParams, *entities.AuthExtended) CreateResponder

// Handle executing the request and returning a response
func (fn CreateHandlerFunc) Handle(params CreateParams, principal *entities.AuthExtended) CreateResponder {
	return fn(params, principal)
}

// CreateHandler interface for that can handle valid create params
type CreateHandler interface {
	Handle(CreateParams, *entities.AuthExtended) CreateResponder
}
...
/*
	Create swagger:route PUT /wash/ wash create
