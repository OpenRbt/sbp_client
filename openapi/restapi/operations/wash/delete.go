...
type DeleteHandlerFunc func(DeleteParams, *entities.AuthExtended) DeleteResponder

// Handle executing the request and returning a response
func (fn DeleteHandlerFunc) Handle(params DeleteParams, principal *entities.AuthExtended) DeleteResponder {
	return fn(params, principal)
}

// DeleteHandler interface for that can handle valid delete params
type DeleteHandler interface {
	Handle(DeleteParams, *entities.AuthExtended) DeleteResponder
}
...
/*
	Delete swagger:route DELETE /wash/ wash delete
