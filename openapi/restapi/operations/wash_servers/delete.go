...
type DeleteHandlerFunc func(DeleteParams, *entities.Auth) DeleteResponder

// Handle executing the request and returning a response
func (fn DeleteHandlerFunc) Handle(params DeleteParams, principal *entities.Auth) DeleteResponder {
	return fn(params, principal)
}

// DeleteHandler interface for that can handle valid delete params
type DeleteHandler interface {
	Handle(DeleteParams, *entities.Auth) DeleteResponder
}
