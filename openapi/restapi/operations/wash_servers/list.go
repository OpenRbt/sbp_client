...
type ListHandlerFunc func(ListParams, *entities.Auth) ListResponder

// Handle executing the request and returning a response
func (fn ListHandlerFunc) Handle(params ListParams, principal *entities.Auth) ListResponder {
	return fn(params, principal)
}

// ListHandler interface for that can handle valid list params
type ListHandler interface {
	Handle(ListParams, *entities.Auth) ListResponder
}
