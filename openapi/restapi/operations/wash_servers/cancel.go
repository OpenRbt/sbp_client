...
type CancelHandlerFunc func(CancelParams, *entities.Auth) CancelResponder

// Handle executing the request and returning a response
func (fn CancelHandlerFunc) Handle(params CancelParams, principal *entities.Auth) CancelResponder {
	return fn(params, principal)
}

// CancelHandler interface for that can handle valid cancel params
type CancelHandler interface {
	Handle(CancelParams, *entities.Auth) CancelResponder
}
